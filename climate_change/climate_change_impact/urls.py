"""climate_change_impact URL Configuration
...
from climate_change_impact import settings
...
urlpatterns = [
    ...
    url(r'^Prediction_Of_Climate_Change_Impact/$', remoteuser.Prediction_Of_Climate_Change_Impact, name="Prediction_Of_Climate_Change_Impact"),
    ...
    url(r'^Find_Prediction_Of_Climate_Change_Impact_Ratio/$', serviceprovider.Find_Prediction_Of_Climate_Change_Impact_Ratio, name="Find_Prediction_Of_Climate_Change_Impact_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Climate_Change_Impact/$', serviceprovider.View_Prediction_Of_Climate_Change_Impact, name="View_Prediction_Of_Climate_Change_Impact"),
